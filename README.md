...
3. **Fork this repository** ([`Faraday-Future-AI/Robothon-starter-test`](https://github.com/Faraday-Future-AI/Robothon-starter-test/fork)) and let your AI set up the run environment.
...
```bash
git clone https://github.com/Faraday-Future-AI/Robothon-starter-test.git
cd $(basename Faraday-Future-AI/Robothon-starter-test)
